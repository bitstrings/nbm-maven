...
|-------------------------------------------------------------------------------------------------------|
|**Q. What is the difference?**<br/>A. The only difference is the groupId<br/>Because the NetBeans IDE explicitly interacts with this plugin, it is in fact hardcoded.|
